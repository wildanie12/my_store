        ...
        <div class="col-8 mt-3">
            <form action="/penjualan/save" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="harga" class="form-control <?= ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" id="harga" autocomplete="off" value="<?= old('harga'); ?>">
                        <div id="validationServer03Feedback" class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="unit" class="form-control <?= ($validation->hasError('unit')) ? 'is-invalid' : ''; ?>" id="unit" autocomplete="off" value="<?= old('unit'); ?>">
                        <div id="validationServer03Feedback" class="invalid-feedback">
